	...
	function legitapi:CreateModule(modulesettings)
		...
		if moduleapi.ApiCategory == 'Hud' and moduleapi.Children then
			moduleapi.HudOverlayButton = mainapi.Overlays:CreateToggle({
				Name = modulesettings.Name,
				Icon = modulesettings.Icon or getcustomasset('aetherv2/assets/new/overlaystab.png'),
...
mainapi:CreateCategory({
	Name = 'Legit',
	Icon = getcustomasset('aetherv2/assets/new/legit.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Utility',
...
local function createConfigManager(categoryapi)
	...
	local function readConfigData(name, bundled)
		local path = bundled and ('aetherv2/configs/'..name..'.json') or getConfigPath(name)
	...
	local function createRow(parent, name, selected, callback, bundled)
		...
		subLabel.Text = bundled and 'AetherV2 Team' or (name == 'default' and 'Default config' or 'Local saved config')
	...
	local function refreshPreview()
		...
		bigBy.Text = bundled and 'by AetherV2 Team' or 'local config'
...
local communityConfigManagerLoader = loadstring(downloadFile('aetherv2/guis/communityconfigs.lua'), 'communityconfigs')
...
createInfoOverlay({
	Name = 'Session Panel',
	Icon = getcustomasset('aetherv2/assets/new/info.png'),
	Size = UDim2.fromOffset(14, 14),
...
createInfoOverlay({
	Name = 'Module Summary',
	Icon = getcustomasset('aetherv2/assets/new/overlaystab.png'),
